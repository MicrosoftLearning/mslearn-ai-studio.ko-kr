...
1. 메시지의 끝에 `End your answer with a follow-up question.`을 추가하여 시스템 메시지를 업데이트합니다. 변경 사항을 저장하고 채팅을 지운 다음 질문하여 다시 채팅을 테스트합니다. `I'm planning a trip to London, what can I do there?` 
