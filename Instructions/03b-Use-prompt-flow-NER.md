---
lab:
  title: Azure AI Foundry 포털에서 NER(명명된 엔터티 인식)에 프롬프트 흐름 사용
---

# Azure AI Foundry 포털에서 NER(명명된 엔터티 인식)에 프롬프트 흐름 사용
...
1. 배포 세부 정보에서 **사용자 지정**을 선택하여 다음 설정으로 **gpt-35-turbo** 모델의 새 배포를 만듭니다.
