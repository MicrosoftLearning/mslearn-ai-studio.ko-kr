...
이제 Azure AI Foundry 프로젝트와 이를 지원하기 위한 Azure AI 리소스를 만들 준비가 되었습니다.
...
1. **프로젝트 만들기** 마법사에서 프로젝트를 통해 자동으로 만들어지는 모든 Azure 리소스를 볼 수 있습니다. **사용자 지정**을 선택하고 Azure AI 검색 리소스에 연결합니다.
...
이제 Azure AI Foundry 포털에서 빌드한 Copilot에 자체 데이터를 통합하는 방법을 경험했으니 더 자세히 살펴보도록 하겠습니다!
